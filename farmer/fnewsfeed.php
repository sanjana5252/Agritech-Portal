...
<?php require ('fheader.php');  ?>
 ...
 <script>
  window.addEventListener("load", function() {
    const endpoint = "https://newsapi.org/v2/everything?q=farmers&sortBy=popularity&apiKey=5e0e165b55964cb78bcf5f92d786683d";
    fetch(endpoint)
    .then(response => {
      if (!response.ok) {
...
<div class="container-fluid ">
	...
	error_reporting(E_ERROR | E_PARSE);
	       ...
	       // https://newsapi.org/v2/everything?q=Agriculture&sortBy=popularity&apiKey=f7d236118d6c4e78a57d1557ab47cdd4
	
        $url="https://newsapi.org/v2/everything?q=farmers&sortBy=popularity&apiKey=f7d236118d6c4e78a57d1557ab47cdd4";   //Your API KEY
