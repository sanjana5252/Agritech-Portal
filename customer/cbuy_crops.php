...
include('../sql.php');
require_once "StripePayment/config.php"; // Make sure this path is correct
                                ...
                                <table class="table table-striped table-bordered table-responsive-md btn-table display" id="myTable">
                                    ...
                                    <?php
                                        ...
                                        $session = \Stripe\Checkout\Session::create([
                                            ...
                                            'mode' => 'payment',
                                            'success_url' => 'http://localhost/agriculture-portal-main/customer/cupdatedb.php',
                                            'cancel_url' => 'http://localhost/agriculture-portal-main/customer/cbuy_crops.php',
                                        ]);
                                    ?>
                                        <tr class="text-dark">
